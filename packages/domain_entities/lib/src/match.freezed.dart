...
abstract class $MatchCopyWith<$Res> {
  ...
  @useResult
  $Res call({String map, String score, String result});
}
...
class _$MatchImpl implements _Match {
  const _$MatchImpl(
      {required this.map, required this.score, required this.result});
  ...
  @override
  String toString() {
    return 'Match(map: $map, score: $score, result: $result)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, map, score, result);
...
abstract class _Match implements Match {
  const factory _Match(
      ...
      required final String result}) = _$MatchImpl;
